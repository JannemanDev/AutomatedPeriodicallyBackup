...
set solutionfolder=C:\Users\JanOonk\source\repos\AutomatedPeriodicallyBackup\
set projectsubfolder=source\AutomatedPeriodicallyBackup\
set project=AutomatedPeriodicallyBackup
set release=Release
